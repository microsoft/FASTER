...
namespace FASTER.core
{
        ...
        where Value : new()
    {
        ...
        public bool ShiftHeadAddress(long newHeadAddress, bool wait)
        {
            ...
            allocator.ShiftReadOnlyAddress(newHeadAddress);

            // Wait for flush to complete
            while (wait && allocator.FlushedUntilAddress < newHeadAddress)
                fht.Refresh();
        ...
        {
            return allocator.ShiftReadOnlyAddress(newReadOnlyAddress);
        }
        ...
        {
            var newReadOnlyAddress = allocator.GetTailAddress();
        ...
        {
            var newHeadAddress = allocator.GetTailAddress();
