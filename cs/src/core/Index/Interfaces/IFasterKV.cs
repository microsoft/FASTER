...
namespace FASTER.core
{
    ...
    /// </summary>
    public interface IFasterKV<Key, Value, StoreFunctions, Allocator> : IDisposable
        ...
        where Allocator : AllocatorBase<Key, Value, StoreFunctions>
    {
        ...
        ClientSession<Key, Value, Input, Output, Context, IFunctions<Key, Value, Input, Output, Context>, StoreFunctions, Allocator> NewSession<Input, Output, Context>(IFunctions<Key, Value, Input, Output, Context> functions,
                string sessionName = null, ReadFlags readFlags = ReadFlags.Default);
        ...
        /// <param name="readFlags">ReadFlags for this session; override those specified at FasterKV level, and may be overridden on individual Read operations</param>
        /// <returns>Session instance</returns>
        ClientSession<Key, Value, Input, Output, Context, IFunctions<Key, Value, Input, Output, Context>, StoreFunctions, Allocator> ResumeSession<Input, Output, Context>(IFunctions<Key, Value, Input, Output, Context> functions,
                string sessionName, out CommitPoint commitPoint, ReadFlags readFlags = ReadFlags.Default);
        ...
        /// </summary>
        LogAccessor<Key, Value, StoreFunctions, Allocator> Log { get; }

        /// <summary>
        /// Get accessor for FASTER read cache
        /// </summary>
        LogAccessor<Key, Value, StoreFunctions, Allocator> ReadCache { get; }
