...
namespace FASTER.core
{
    ...
    {
        /// <inheritdoc />
        public override bool InPlaceUpdater(ref Key key, ref Value input, ref Value value, ref Value output, ref RecordInfo recordInfo, ref UpdateInfo updateInfo, long address) => true;
        /// <inheritdoc />
        public override bool NeedCopyUpdate(ref Key key, ref Value input, ref Value oldValue, ref Value output, ref UpdateInfo updateInfo) => false;
    }
