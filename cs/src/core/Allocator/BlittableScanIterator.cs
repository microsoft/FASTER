...
namespace FASTER.core
{
    ...
    /// </summary>
    public sealed class BlittableScanIterator<Key, Value, StoreFunctions> : ScanIteratorBase, IFasterScanIterator<Key, Value>
        where StoreFunctions : IStoreFunctions<Key, Value>
    {
        private readonly BlittableAllocator<Key, Value, StoreFunctions> hlog;
        ...
        public BlittableScanIterator(BlittableAllocator<Key, Value, StoreFunctions> hlog, long beginAddress, long endAddress, ScanBufferingMode scanBufferingMode, LightEpoch epoch, bool forceInMemory = false)
