...
namespace FASTER.core
{
    public partial class FasterKV<Key, Value, StoreFunctions, Allocator>
    {
        ...
        {
            /// <inheritdoc/>
            public DeleteAsyncResult<Input, Output, Context> CreateResult(Status status, Output output, RecordMetadata recordMetadata) => new(status);
            ...
            /// <inheritdoc/>
            public ValueTask<DeleteAsyncResult<Input, Output, Context>> DoSlowOperation(FasterKV<Key, Value, StoreFunctions, Allocator> fasterKV, IFasterSession<Key, Value, Input, Output, Context, Allocator> fasterSession,
        ...
        public struct DeleteAsyncResult<Input, Output, Context>
        {
            ...
            internal DeleteAsyncResult(FasterKV<Key, Value, StoreFunctions, Allocator> fasterKV, IFasterSession<Key, Value, Input, Output, Context, Allocator> fasterSession,
