...
namespace FASTER.core
{
    ...
    public class SpanByteAdvancedFunctions<Context> : SpanByteAdvancedFunctions<SpanByte, SpanByteAndMemory, Context>
    {
        ...
        /// <inheritdoc />
        public unsafe override void SingleReader(ref SpanByte key, ref SpanByte input, ref SpanByte value, ref SpanByteAndMemory dst, long address)
        {
            value.CopyTo(ref dst, memoryPool);
        }

        /// <inheritdoc />
        public unsafe override void ConcurrentReader(ref SpanByte key, ref SpanByte input, ref SpanByte value, ref SpanByteAndMemory dst, ref RecordInfo recordInfo, long address)
        {
            value.CopyTo(ref dst, memoryPool);
        }
