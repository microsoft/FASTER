...
namespace ReadAddress
{
    ...
    public class Functions : SimpleFunctions<Key, Value>
    {
        ...
        public override bool ConcurrentWriter(ref Key key, ref Value input, ref Value src, ref Value dst, ref Value output, ref RecordInfo recordInfo, long address) => false;
