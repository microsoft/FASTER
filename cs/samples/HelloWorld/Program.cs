...
namespace HelloWorld
{
    ...
    public class Program
    {
        ...
        static void InMemorySample()
        {
            ...
            if (status.IsFound && output == value)
            ...
            if (status.IsFound && output == input1 + input2)
            ...
            if (status.IsNotFound && status2.IsFound && status3.IsFound && output == input1)
        ...
        static void DiskSample()
        {
            ...
            if (status.IsPending)
            {
                ...
                while (iter.Next())
                {
                    if (iter.Current.Status.IsFound && iter.Current.Output == value)
                        Console.WriteLine("(2) Success!");
                    else
                        Console.WriteLine("(2) Error!");
                }
