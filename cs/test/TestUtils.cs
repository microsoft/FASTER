    ...
    internal static class TestUtils
    {
        ...
        private static string ConvertedClassName
        {
            get
            {
                ...
                return $"{prefix}/{TestContext.CurrentContext.Test.ClassName.Substring(prefix.Length + 1)}";
            }
        }
        ...
        internal static string AzureMethodTestContainer => $"{ConvertedClassName}/{TestContext.CurrentContext.Test.MethodName}";
