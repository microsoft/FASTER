...
namespace FASTER.test
{
    ...
    public class MyFunctions : FunctionsBase<MyKey, MyValue, MyInput, MyOutput, Empty>
    {
        ...
        public override void SingleWriter(WriteReason reason, ref MyKey key, ref MyInput input, ref MyValue src, ref MyValue dst, ref MyOutput output, ref RecordInfo recordInfo, long address)
        {
            dst = src;
        }
    }
    ...
    public class MyFunctions2 : FunctionsBase<MyValue, MyValue, MyInput, MyOutput, Empty>
    {
        ...
        public override void SingleWriter(WriteReason reason, ref MyValue key, ref MyInput input, ref MyValue src, ref MyValue dst, ref MyOutput output, ref RecordInfo recordInfo, long address)
        {
            dst = src;
        }
    }
    ...
    public class MixedFunctions : FunctionsBase<int, MyValue, MyInput, MyOutput, Empty>
    {
        ...
        public override void SingleWriter(WriteReason reason, ref int key, ref MyInput input, ref MyValue src, ref MyValue dst, ref MyOutput output, ref RecordInfo recordInfo, long address)
        {
            dst = src;
        }
    }
    ...
    public class MyLargeFunctions : FunctionsBase<MyKey, MyLargeValue, MyInput, MyLargeOutput, Empty>
    {
        ...
        public override void SingleWriter(WriteReason reason, ref MyKey key, ref MyInput input, ref MyLargeValue src, ref MyLargeValue dst, ref MyLargeOutput output, ref RecordInfo recordInfo, long address)
        {
            dst = src;
        }
    }
