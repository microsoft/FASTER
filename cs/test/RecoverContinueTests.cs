    ...
    internal class RecoverContinueTests
    {
        ...
        public void Setup()
        {
            ...
            fht1 = new FasterKV
                ...
                checkpointSettings: new CheckpointSettings { CheckpointBasePath = TestContext.CurrentContext.TestDirectory + "\\checkpoints3", CheckPointType = CheckpointType.Snapshot }
                );
