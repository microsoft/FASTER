...
namespace FASTER.test.LockTests
{
    ...
    internal class BasicLockTests
    {
        internal class Functions : SimpleFunctions<int, int>
        {
            ...
            public override bool ConcurrentWriter(ref int key, ref int input, ref int src, ref int dst, ref int output, ref RecordInfo recordInfo, ref UpsertInfo upsertInfo) => Increment(ref dst);

            public override bool InPlaceUpdater(ref int key, ref int input, ref int value, ref int output, ref RecordInfo recordInfo, ref RMWInfo rmwInfo) => Increment(ref value);
        }
