...
namespace FASTER.test.recovery.objects
{
    ...
    public class MyFunctions : FunctionsBase<MyKey, MyValue, MyInput, MyOutput, MyContext>
    {
        ...
        public override void ReadCompletionCallback(ref MyKey key, ref MyInput input, ref MyOutput output, MyContext ctx, Status status, RecordInfo recordInfo) => ctx.Populate(ref status, ref output);
    }
}
