...
namespace FASTER.test
{
    ...
    internal class PostOperationsTests
    {
        class PostFunctions : SimpleFunctions<int, int>
        {
            ...
            public override void PostSingleWriter(WriteReason reason, ref int key, ref int input, ref int src, ref int dst, ref int output, ref RecordInfo recordInfo, long address) { this.pswAddress = address; }
