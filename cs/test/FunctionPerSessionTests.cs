...
namespace FASTER.test
{
    ...
    public class RefCountedAdder : FunctionsBase<int, RefCountedValue, long, Empty, Empty>
    {
        ...
        public override void InitialUpdater(ref int key, ref long input, ref RefCountedValue value, ref Empty output, ref RecordInfo recordInfo, ref RMWInfo rmwInfo)
        {
        ...
        public override void CopyUpdater(ref int key, ref long input, ref RefCountedValue oldValue, ref RefCountedValue newValue, ref Empty output, ref RecordInfo recordInfo, ref RMWInfo rmwInfo)
        {
    ...
    public class RefCountedRemover : FunctionsBase<int, RefCountedValue, Empty, Empty, Empty>
    {
        ...
        public override void InitialUpdater(ref int key, ref Empty input, ref RefCountedValue value, ref Empty output, ref RecordInfo recordInfo, ref RMWInfo rmwInfo)
        {
            Interlocked.Increment(ref InitialCount);
        ...
        public override void CopyUpdater(ref int key, ref Empty input, ref RefCountedValue oldValue, ref RefCountedValue newValue, ref Empty output, ref RecordInfo recordInfo, ref RMWInfo rmwInfo)
        {
            Interlocked.Increment(ref CopyCount);
